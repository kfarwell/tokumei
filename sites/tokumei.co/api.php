...
if(isset($_GET['d'])) {
    ...
    switch ($_GET['d']) {
        ...
        exit('Something went wrong, nothing to do.');}
	...
	exit('Please provide a valid argument. Example: curl -i -F name=test.jpg -F file=@localfile.jpg https://scholarly.me/api.php?d=upload');
	break;
    }
}else{
    //*1
